...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function make_dendro_crop_buttons(cgm) {
	  ...
	  if (d3.select('.row_dendro_icons_container').classed('ran_filter') === false) {
	    ...
	    // append undo icon
	    .append('text').classed('row_dendro_crop_buttons', true).attr('text-anchor', 'middle').attr('dominant-baseline', 'central').attr('font-family', 'FontAwesome').attr('font-size', '20px')
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function run_transformation(params) {
	  ...
	  d3.select(params.root + ' .row_dendro_icons_container').selectAll('path').attr('d', function (d) {
