...
/***/ function(module, exports) {
	...
	module.exports = function make_colorbar(cgm) {
	  ...
	  var main_svg = d3.select(params.root + ' .sidebar_wrapper').append('svg').attr('height', svg_height + 'px').attr('width', svg_height + 'px');
	  ...
	  main_svg.append('text').text('-' + max_abs_val.toLocaleString()).style('font-family', '"Helvetica Neue", Helvetica, Arial, sans-serif').style('font-weight', 300).style('font-size', 15).attr('transform', 'translate(' + low_left_margin + ',' + low_top_margin + ')').attr('text-anchor', 'start');

	  main_svg.append('text').text(max_abs_val.toLocaleString()).style('font-family', '"Helvetica Neue", Helvetica, Arial, sans-serif').style('font-weight', 300).style('font-size', 15).attr('transform', 'translate(' + high_left_margin + ',' + high_top_margin + ')').attr('text-anchor', 'end');
		};
