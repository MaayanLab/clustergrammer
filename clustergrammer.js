	...
	module.exports = function ini_sidebar(cgm) {
	  ...
	  _.each(reorder_types, function (inst_rc) {
	    ...
	    if (d3.select(params.root + ' .slider_' + inst_rc).select('#handle-one').empty()) {
	      ...
	      (function () {
	        var run_on_dendro_slide = function run_on_dendro_slide(evt, value) {
	          $("#amount").val("$" + value);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../css-loader/index.js!./d3.slider.css", function() {
				var newContent = require("!!./../css-loader/index.js!./d3.slider.css");
