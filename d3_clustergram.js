...
function Viz(args) {
  ...
  function sort_by_rc(inst_type, inst_row){

    console.log('sorting by row or column');
    // console.log(matrix.get_matrix());
    // console.log(matrix.get_nodes('row'))
    ...
    var mat = matrix.get_matrix();

    // get row_nodes from global variable
    var row_nodes = matrix.get_nodes('row');
    var col_nodes = matrix.get_nodes('col');
