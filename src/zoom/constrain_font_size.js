...
module.exports = function(params, trans=false) {
  ...
  var real_font_size = params.labels.default_fs_row * params.zoom_behavior.scale();

  if (real_font_size > params.labels.max_allow_fs){
  ...
  // console.log(params.labels.max_label_char)
