...
module.exports = function show_visible_area(params, zoom_info){
  ...
  vis_area.min_x = Math.abs(zoom_info.trans_x)/zoom_info.zoom_x - params.viz.rect_width;
  vis_area.min_y = Math.abs(zoom_info.trans_y)/zoom_info.zoom_y - params.viz.rect_height ;
